...
#--------change by xiao--------20110620-----------begin--------
#----below is original one------begin--------
#badOperators = '*'
#----above is original one------end----------

#because when json file includes "*" such as "Cape Town*", it error
badOperators = ''   
#--------change by xiao--------20110621-----------end--------
